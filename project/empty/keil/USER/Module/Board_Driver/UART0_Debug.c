...
void UART_DEBUG_INST_IRQHandler(void)
{
	...
	{
			char received_char = DL_UART_Main_receiveData(UART_DEBUG_INST);
			debug_uart0.receive_buffer[ debug_uart0.receive_data_length++ ] = received_char;
			debug_uart_receive_limit_length();
			debug_uart_send_char(received_char);		
	}
}
